...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'hx@livetv.in.eu.org',
  ...
  footer:
    'Powered by <a href="https://github.com/oVo-HxBots" target="_blank" rel="noopener noreferrer">oVo-HxBots</a>. Made with ❤ by oVo-HxBots.',
  ...
  email: 'mailto:hx@livetv.in.eu.org',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/oVo-HxBots',
    },
  ],
  ...
  datetimeFormat: 'DD-MM-YYY hh:mm:ss A',
}
